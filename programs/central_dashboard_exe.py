#!/usr/bin/env python3
"""PyInstaller entrypoint for the Windows central dashboard EXE."""
...
def main() -> None:
    ...
    config_path = Path(
        os.environ.get("AISENTINEL_CENTRAL_CONFIG", str(_default_config_path(app_dir)))
    ).expanduser()
    ...
    print()
    print("=" * 78)
    print("  AISENTINEL - Central Dashboard EXE")
